export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <main className="min-h-screen bg-[linear-gradient(180deg,#f8fbff_0%,#f5f7fb_48%,#eef4f7_100%)] dark:bg-[linear-gradient(180deg,#020617_0%,#0f172a_52%,#111827_100%)]">
      <div className="grid min-h-screen lg:grid-cols-[1.08fr_0.92fr]">
        <section className="relative hidden overflow-hidden border-r border-slate-200/70 px-10 py-10 lg:flex lg:flex-col lg:justify-center dark:border-slate-800/80">
          ...
          <div className="relative">
            ...
            <div className="mt-10 max-w-2xl space-y-6">
              ...
              <h1 className="max-w-2xl text-5xl font-semibold leading-[1.05] tracking-tight text-slate-950 dark:text-slate-50">
            ...
            <div className="mt-10 grid gap-4 sm:grid-cols-3">
              {[
                ...
                <div key={item.label} className="rounded-[24px] border border-white/90 bg-white/82 p-5 shadow-[0_18px_40px_-28px_rgba(15,23,42,0.16)] dark:border-slate-800/80 dark:bg-slate-950/76 dark:shadow-[0_18px_40px_-28px_rgba(2,6,23,0.7)]">
                  <p className="text-sm font-semibold text-slate-900 dark:text-slate-100">{item.label}</p>
                  <p className="mt-2 text-sm leading-6 text-slate-500 dark:text-slate-400">{item.detail}</p>
                </div>
              ))}
            </div>
            <div className="mt-8 inline-flex flex-wrap items-center gap-3 rounded-[24px] border border-white/90 bg-white/82 px-5 py-4 shadow-[0_18px_40px_-28px_rgba(15,23,42,0.16)] dark:border-slate-800/80 dark:bg-slate-950/76 dark:shadow-[0_18px_40px_-28px_rgba(2,6,23,0.7)]">
